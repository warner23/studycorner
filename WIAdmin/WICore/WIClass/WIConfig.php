...
define('SCRIPT_URL', "http://wliterature.com/Trintiy/");
...
define('SUCCESS_LOGIN_REDIRECT', serialize(array( 'default' => "home.php" ))); 
...
define('REGISTER_CONFIRM', "http://wliterature.com/Trintiy/confirm.php"); 

define('REGISTER_PASSWORD_RESET', "http://wliterature.com/Trintiy/passwordreset.php"); 
...
define('SOCIAL_CALLBACK_URI', "http://wliterature.com/Trintiy/WIVendor/hybridauth/"); 
