...
return array(
	...
	"term" => "The River Terms of Use",

	"respect" => "Respect the other users",

	"dis" => " We dont stand for Racism, foul language",

	"play" => "Be courtous",

	"humancheck" => "Please remove all of this text",
	...
	"our_community_shop_and_cafe"   => "Our Community Shop and Cafe",
	...
	"HI&WEL"  => "The River Manchester",

	"main_title" => "Hello and Welcome",

	"main_welcome"   =>  " At the river Manchester, we have a passion for helping people made vulnerable through facing or fleeing situations of Domestic Violence abuse and forced isolcation. We combine a spirit of care, love, hope and healing with a practical approach to assisting and empowering our clients. They bring assocated issues such as fear, poverty abd homelessness. We provide a safe space, friendship and a listening ear in the first instance. <br />We can also provide materials assitstnace abndsupport, advice, in house training, a gateway to other services, and the community links.  We aim to build confidence and empower our clients to move on and create better lives for themselves,- hence 'bring hope', 'changing Lives'. <br />
         Although we are founded on princles coming from a christian persective, th people we help are of all denominations abd none. <br /> See about us to find out more about what we do and how we do it. ",

    "involved"   => "Get Your Friends Involved ",      
...
",
	...
	"successfully_added_contact" => " successfully added new contact",
