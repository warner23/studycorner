    ...
    public function register($data) 
    {
        ...
        if(count($errors) == 0) {
           ...
           //pull the variables out of the array
            ...
            $query = $this->WIdb->prepare('INSERT INTO `WI_Members` (`email`, `username`, `password`, `confirmed`, `confirmation_key`, `register_date`, `ip_addr`) VALUES (:email, :username, :password, :confirmed, :confirmation_key, :register_date, :ip)');
