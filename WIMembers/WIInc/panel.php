  ...
  <div id="panel">
    <div class="content clearfix">
      <div class="left">
        ...
        <h2><?php echo WILang::get('TO');?> <strong>The River</strong></h2>
        <p class="grey"></p>
       ...
       <?php if(!$login->isLoggedIn())
        {
          ...
          <div class="modal-body">
                        ...
                        <div class="control-group  form-group">
                            ...
                            <div class="controls col-lg-8">
                                <input type="text" id="reg-username" class="input-xlarge form-control">
                                                ...
                                                <div class="control-group  form-group">
                            <label class="control-label col-lg-4" for="reg-usergroup"><?php echo WILang::get('usergroup'); ?> <span class="required">*</span></label>
                            <div class="controls col-lg-8">
                                <select type="text" id="reg-usergroup" class="input-xlarge form-control">
                  ...
                  <div class="social-login">
                      <?php if ( TWITTER_ENABLED ): ?>
                          <a href="socialauth.php?p=twitter&token=<?php echo $token; ?>">
                              <img src="WIMedia/Img/social/twitter.png" class="fade high-opacity" alt="Twitter" title="<?php echo WILang::get('login_with'); ?> Twitter"/>
                          </a>
                      <?php endif; ?>
                      <?php if ( FACEBOOK_ENABLED ): ?>
                          <a href="socialauth.php?p=facebook&token=<?php echo $token; ?>">
                              <img src="WIMedia/Img/social/fb.png" class="fade high-opacity" alt="Facebook" title="<?php echo WILang::get('login_with'); ?> Facebook"/>
                          </a>
                      <?php endif; ?>
                      <?php if ( GOOGLE_ENABLED ): ?>
                          <a href="socialauth.php?p=google&token=<?php echo $token; ?>">
                              <img src="WIMedia/Img/social/gplus.png" class="fade high-opacity" alt="Google+" title="<?php echo WILang::get('login_with'); ?> GooglePlus"/>
                          </a>
                      <?php endif; ?>
                  </div>
            ...
            <a href="<?php $WI['site_url'];?>WIMembers/profile.php?id=<?php ?>"><?php echo WILang::get('view_profile_page'); ?></a>
            <p>- or -</p>
            <a href="<?php $WI['site_url'];?>logout.php"><?php echo WILang::get('log_off'); ?></a>
            <p>- or -</p>
            <a href="<?php $WI['site_url'];?>WIAdmin/home.php"><?php echo WILang::get('admin_panel'); ?>  </a>
            ...
            <a href="<?php $WI['site_url'];?>WIMembers/profile.php?id=<?php echo WISession::get("user_id");?>"><?php echo WILang::get('view_profile_page'); ?>  </a>
            <p>- or -</p>
            <a href="<?php $WI['site_url'];?>logout.php"><?php echo WILang::get('log_off'); ?></a>
...
$('#reg-usergroup').val($('option:selected').text());
