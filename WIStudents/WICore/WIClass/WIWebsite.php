                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div id="nav">
                                <ul id="mainMenu" class="mainMenu default">
                                    ...
                                    <li><a href="http://studycorner.co.uk/WIStudents/services.php">' . WILang::get("myresources") . '</a> </li>
                                    <li><a href="http://studycorner.co.uk/WIStudents/mycourses.php">' . WILang::get("mycoruses") . '</a></li>
                                </ul>
                            </div><!-- nav -->   
                    <!-- end of menu -->
                        </div>
