...
class WIdb extends PDO
{
    ...
    public function insert($table, $data)
    {
        ...
        $sth = $this->WIdb->prepare("INSERT INTO $table (`$fieldNames`) VALUES ($fieldValues)");
    ...
    public function update($table, $data, $where, $whereBindArray = array())
    {
        ...
        $sth = $this->WIdb->prepare("UPDATE $table SET $fieldDetails WHERE $where");
    ...
    public function delete($table, $where, $bind = array(), $limit = 1)
    {
        ...
        $sth = $this->WIdb->prepare("DELETE FROM $table WHERE $where LIMIT $limit");
