...
switch ($action) {
    ...
    case "getUser":
        ...
        $course = new WICourses();
        $course->WICourse($_POST['id']);
        break;
        ...
        $course = new WICourses();
        $course->Enrol($_POST['id'], $_POST['user_id'], $_POST['teacher'], $_POST['skills'], $_POST['name'], $_POST['description'], $_POST['img']);
        break;
        ...
        $chat = new WIChat();
        //$course->CheckCourse($_POST['id'], $_POST['user_id']);
        $chat->CheckCourse($_POST['id'], $_POST['user_id']);
         break;
