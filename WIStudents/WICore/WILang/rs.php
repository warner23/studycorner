...
return array(
	...
	"your_email" => "vaša емаил",

	"login_with" => "Пријавите се",
...
Поновите лозинку",
	...
	"you_can_login_now" => "Можете<a href='{link}'>
лог ин</a> сада.",

	"user_with_key_doesnt_exist" => "
Корисник са овим кључем не постоји у нашој бази.",
    ...
    // panel mini admin
    "panel_mini_admin"    => "Админ мини панел",
	...
	"mycoruses"  =>  "Моји Курсеви",
	

	// index.php

	"welcome_"  => "Добродошли у",

	"main_title" => "
Мука ми је од лоших учитеља, или местима која намећу ограничења на вас, или само траже негде да уче.",

	"community"   =>  "заједница",   

    "learn"    =>  "
Поносимо оурселввес на водећи вас у стварном животу каријере",

    "head_courses"   => "kursevi",

    "head_student"   => "Студенти",

    "course_desc"  =>  "Имамо низ курсева намењених да вам помогну да научите у корак.",

    "student_desc"  =>  "
Студент овде су наша Но1 приоти",


    "view_details"  => "Приказ детаља",

    "footer"   => "
Направљен и Развијен од стране ВИ: Варнер-Инфинити",
	...
	"units" =>  "Струцтерал јединице",

	"homeo"  => "Хомеостаза",

	"summary"  =>  "Резиме Иза линије",
	...
	"tab_intro"  =>  "
Каматне у људском телу и како се функције вероватно развијен када су наши преци почели да размишљају о разлозима због којих људи се разболео и умро. Све претходне културе имао неког означено као исцелитељ који је био одговоран за проналажење биљки које излечени поремећаја тела. Овај исцелитељ и био одговоран за молитву или позивање на помоћ из прошлости предака да помогне у процесу лечења <бр />
        Као култура развила и наука почела да се развија, интересовање за и знање о људском телу напредовала. Леонардо да Винчи (1452-1519), италијански, први је правилно илуструју људски скелет са свим својим костима.
        <бр />
        Фламански анатом Андреас Везалијус (1514-1564) је написао књигу о људском телу, а енглески анатом Вилијам Харви (1578-1657) открио је како крв циркулише кроз тело. Ово су само неке од многих сарадника и додаје нашем разумевању људског тела и како то функционише. <бр />
       Анатомија је проучавање структуре или морфологије тела и како су организовани делови тела. Физиологија је проучавање функција делова тела, шта раде и како то раде. Ове две области организације тела су тако уско повезани да је тешко да их раздвоји. На пример, наша уста има зубе да разбије храну механички, а језик који има укус храну и манипулише га, и пљувачних жлезда које производе пљувачке која садржи ензиме који разлажу сложене угљене хидрате у просте шећере, чиме започиње процес варења. Патологија је наука о болести тела. <бр />
       Ми још увек не знамо све о томе како функционише људски организам. Истраживање је још увек дешава данас да открије тајне овог комплексног јединице смо се зовемо. Да би се олакшало униформност термина, научници су усвојили четири основне референтне системе телесне организације. Ови системи су правци, авиони, шупљине, и структурне јединице. Када се говори о смислу правца, авиона, и шупљине, људско тело је усправно и лицем напред. Руке су на странама и дланове и стопала су постављене према предњем (слика 1-1). Све описи локације или положаја претпоставити да тело буде у овом положају.",
