...
Bienvenue à",
	...
	"main_title" => "
Malade de mauvais enseignants, ou des lieux qui imposent des limitations sur vous, ou tout simplement à la recherche d'un endroit pour apprendre.",

	"community"   =>  "Communauté",   

    "learn"    =>  "
Nous sommes fiers ourselvves de vous guider en véritables carrières de la vie",
    ...
    "course_desc"  =>  "
Nous avons une gamme de cours conçus pour vous aider à apprendre à votre rythme.",

    "student_desc"  =>  "
Student voici notre prioty no1",
...
// anatomy and physiology
	...
	"tof"  =>  "Conditions d'orientation",

	"Planes"  =>  "Planes",

	"cab"  =>  "Caries",

	"units" =>  "Unités Structeral",

	"homeo"  => "homéostasie",

	"summary"  =>  "Résumé du cadre",
	...
	"tab_intro"  =>  "
fonctions d'intérêt dans le corps humain et comment il a probablement développé quand nos ancêtres ont commencé à réfléchir sur les raisons pour lesquelles les gens sont tombés malades et sont morts. Toutes les cultures antérieures avaient quelqu'un désigné comme un guérisseur qui était responsable de trouver des plantes et des herbes qui guérissent les troubles du corps. Ce guérisseur était également responsable de prier ou d'invoquer l'aide des ancêtres dans le passé pour aider à la <br /> processus de guérison
        Comme les cultures développées et la science ont commencé à évoluer, l'intérêt et les connaissances sur le corps humain avancé. Leonardo da Vinci (1452-1519), un Italien, a été le premier à illustrer correctement le squelette humain avec tous ses os.
        <br />
        L'anatomiste flamand Andreas Vesalius (1514-1564) a écrit un livre sur le corps humain, et les Anglais anatomiste William Harvey (1578-1657) a découvert comment le sang circule dans le corps. Ce ne sont que quelques-uns des nombreux contributeurs qui ont ajouté à notre compréhension du corps humain et comment il fonctionne. <br />
       Anatomie est l'étude de la structure ou de la morphologie du corps et de la façon dont les parties du corps sont organisées. La physiologie est l'étude des fonctions des parties du corps, ce qu'ils font et comment ils le font. Ces deux domaines de l'organisation du corps sont si étroitement associés qu'il est difficile de les séparer. Par exemple, notre bouche a des dents à décomposer les aliments mécaniquement, une langue qui goûte la nourriture et le manipule, et les glandes salivaires qui produisent la salive contenant des enzymes qui décomposent les glucides complexes en sucres simples, en commençant ainsi le processus de digestion. La pathologie est l'étude des maladies du corps. <br />
       Nous ne savons toujours pas tout sur la façon dont les fonctions du corps humain. La recherche est toujours en cours aujourd'hui pour découvrir les mystères de cette unité complexe que nous nous appelons. Pour faciliter l'uniformité des termes, les scientifiques ont adopté quatre systèmes de référence de base de l'organisation corporelle. Ces systèmes sont des directions, des avions, des cavités, et les unités structurelles. Lorsqu'on se réfère à des termes de direction, des avions et des cavités, le corps humain est debout et tourné vers l'avant. Les bras sont sur les côtés et les paumes de la main et les pieds sont positionnés vers l'avant (Figure 1-1). Toutes les descriptions de l'emplacement ou de position prennent le corps à être dans cette posture.",
