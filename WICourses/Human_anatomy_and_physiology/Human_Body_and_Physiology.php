...
<div class="panel panel-default">                
 ...
 <div class="panel-heading">Anatomy And Physiology</div>                 
  <div class="panel-body">                    
  <p>anatomy, physiology, chemistry, biology</p>                 
  </div>              			
...
<thead>			               
 ...
 <th></th>			                 
  ...
  <td>Introduction</td>			                  
  <td>Not started</td>			                  
  <td><a href="HAAP/haap_intro.php" id="start" role="button" class="btn ui-button ui-corner-all ui-widget">Start Module</a></td>			               
   </tr>			                
   <tr>			                  
   <td>2</td>			                 
    <td>Godfather</td>			                  
...
$(document).ready(function(){
	$("#start").click(function(){
		window.location = "HAAP/haap_intro.php";
	})
});
