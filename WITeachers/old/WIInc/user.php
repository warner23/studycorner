          ...
          <div class="span9 users-wrapper">
             ...
             <!-- <?php  //$user_role 3 => admin ?> -->
              <?php $users = $WIdb->select("SELECT * FROM `WI_Members` WHERE `user_role` != '3' ORDER BY `register_date` DESC"); ?>
...
<!--                  <th>--><?php //echo WILang::get('last_login'); ?><!--</th>-->
                  ...
                  <?php foreach ($users as $user): ?>
                      <?php $tmpUser = new WIUser($user['user_id']); ?>
...
<!--                          <td>--><?php //echo $user['last_login']; ?><!--</td>-->
        ...
        <script type="text/javascript" src="WICore/js/sha512.js"></script>
        <script src="WICore/js/WICore.js" type="text/javascript" charset="utf-8"></script>
        <script src="WICore/js/users.js" type="text/javascript" charset="utf-8"></script>
        <script src="WICore/js/index.js" type="text/javascript" charset="utf-8"></script>
