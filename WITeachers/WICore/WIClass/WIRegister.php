...
class WIRegister  
{
    ...
    public function register($data) 
    {
        ...
        if(count($errors) == 0) {
           ...
           //pull the variables out of the array
            $email                = $user['email'];
            ...
            $query = $this->WIdb->prepare('INSERT INTO `WI_Members` (`email`, `username`, `usergroup`, `password`, `confirmed`, `confirmation_key`, `register_date`, `ip_addr`) VALUES (:email, :username, :usergroup, :password, :confirmed, :confirmation_key, :register_date, :ip)');
            $query->bindParam(':email', $email, PDO::PARAM_STR);
            $query->bindParam(':username', $username, PDO::PARAM_STR);
            $query->bindParam(':usergroup', $usergroup, PDO::PARAM_STR);
            $query->bindParam(':password', $password, PDO::PARAM_STR);
            $query->bindParam(':confirmed', $confirmed, PDO::PARAM_STR);
            $query->bindParam(':confirmation_key', $confirmation_key, PDO::PARAM_STR);
            $query->bindParam(':register_date', $register_date, PDO::PARAM_STR);
