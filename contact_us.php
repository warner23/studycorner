...
$web->header();			
 ...
 <!-- content-->
        <?php include_once 'WIInc/contact_us.php'; ?>
	...
	<!--End Wrapper-->
	       	   	 ...
	       	   	 <script type="text/javascript" src="<?php echo $WI['theme_dir'] ?><?php echo $WI['js_site'] ?>vendor/jquery.js"></script>
	              	     ...
	              	     <!-- jQuery cookie --> 
	              	   	 ...
	              	   	 <script type="text/javascript" src="<?php echo $WI['theme_dir'] ?><?php echo $WI['js_site'] ?>plugin/jquery.validate.js"></script>
	              	   	 <script type="text/javascript" src="<?php echo $WI['theme_dir'] ?><?php echo $WI['js_site'] ?>jquery.gmap.js"></script>	
