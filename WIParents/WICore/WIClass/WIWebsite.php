                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="navbar_brand">
                                <a href="index.php">
                                <img alt=""  class="logo" src="WIMedia/Img/header/' . $res['logo'] .'.jpg"></a>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div id="nav">
                                <ul id="mainMenu" class="mainMenu default">
                                    <li class="active"><a href="http://studycorner.co.uk/index.php">Home</a>
                                    </li>
                                    <li><a href="http://studycorner.co.uk/courses.php">Courses</a></li>
                                    <li><a href="http://studycorner.co.uk/services.php">Resources</a> </li>
                                    <li><a href="http://studycorner.co.uk/mycourses.php">My Courses</a></li>
                                </ul>
                            </div><!-- nav -->   
                    <!-- end of menu -->
                        </div>
