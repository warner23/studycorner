                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12">
                            <div id="nav">
                                <ul id="mainMenu" class="mainMenu default">
                                    <li class="active"><a href="index.php">' . WILang::get("home") . '</a>
                                    </li>
                                    <li><a href="courses.php">' . WILang::get("courses") . '</a></li>
                                    
                                    <li><a href="WITeachers/index.php">' . WILang::get("teachers") . '</a></li>
                                    <li><a href="WIStudents/index.php">' . WILang::get("student") . '</a></li>
                                    <li><a href="WIParents/index.php">' . WILang::get("parents") . '</a></li>
                                </ul>
                            </div><!-- nav -->   
                    <!-- end of menu -->
                        </div>
