...
class WIdb extends PDO
{
    ...
    public function select($sql, $array = array(), $fetchMode = PDO::FETCH_ASSOC)
    {
        ...
        public function selectWhile($sql, $array = array(), $while, $fetchMode = PDO::FETCH_ASSOC)
    {
        $this->WIdb = self::getInstance();
        ...
        while($result = $smt->fetch($fetchMode))
        {
            echo $while;
        }
    ...
    public function selectFetch($sql, $array = array(), $fetchMode = PDO::FETCH_ASSOC)
    {
        $this->WIdb = self::getInstance();
    ...
    public function selectColumn($sql, $array = array(), $column, $fetchMode = PDO::FETCH_ASSOC)
    {
        ...
        public function FetchColumn($sql, $array = array(), $fetchMode = PDO::FETCH_ASSOC)
    {
        $this->WIdb = self::getInstance();
